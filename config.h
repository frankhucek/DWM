...
static const Rule rules[] = {
    ...
    { "netbeans",           NULL,       NULL,       1 << 3,         False,          False,          -1 }
...
static const char *web[] = { "google-chrome-stable", NULL, "Google-chrome" };
static const char *vbox[] = { "virtualbox", NULL };
static const char *netbeans[] = { "netbeans", NULL, "netbeans"};
static const char *volumeGUI[] = { "pavucontrol", NULL};


static Key keys[] = {
    { MODKEY,           XK_p,       spawn,          {.v = menu } },
    { MODKEY,           XK_Return,  spawn,          {.v = term } },
    { MODKEY,           XK_i,       runorraise,     {.v = web } },
    { MODKEY|ShiftMask, XK_v,       spawn,          {.v = vbox } },
    { MODKEY,           XK_v,       spawn,          {.v = volumeGUI } },
    { MODKEY,           XK_n,       runorraise,     {.v = netbeans } },
